...
public interface INodeService
{
    ...
    Task<RowOpResult> SaveNode(Node node, bool saveChanges = true);
    Task DeleteNodesForDataProvider(int dataProviderID, bool saveChanges = true);
    Task<RowOpResult> ReplaceNodesForParent(string parentNativeID, int parentDataProviderID, int dataProviderID, NodeEntityType entityType, bool isRelatedToParent, List<Node> nodes);
    Task<RowOpResult> ReplaceNodesForEntity(string entityNativeID, int entityDataProviderID, NodeEntityType entityType, bool isRelatedToParent, List<Node> nodes);
    Task ImportNodes(IEnumerable<Node> nodes);
    Task<RowOpResult> DeleteNode(Node node, bool saveChanges = true);
    ...
    Task<RowOpResult> DeleteNodesForEntity(string entityNativeID, int dataProviderID, NodeEntityType entityType, bool saveChanges = true);
